...
exports.messages = {
    ...
    controllers: {
        user: {
            createUserFailed: "Missing required parameters: :firstname, :lastname, :username, :password",
            getUserByIdFailed: "Missing required parameters: :id",
            updateUserFailed: "Missing required parameters: :firstname, :lastname, :id",
        ...
        order: {
            createOrderFailed: "Missing required parameters: :products, :status, :user_id",
            getOrderByIdFailed: "Missing required parameters: :id",
            updateOrderFailed: "Missing required parameters: :products, :status, :user_id",
